...
export default function EditarPropietarioPage() {
  ...
  useEffect(() => {
    if (id) {
      ...
      if (propietario) {
        ...
        setCodigoPostal(propietario.codigoPostal || '');
        
        // Cargar inquilinos vinculados
        setInquilinosVinculados(getInquilinosByPropietarioId(id));
      } else {
        setSnackbar({ open: true, message: 'Propietario no encontrado', severity: 'error' });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updated = updatePropietario(id, {
      tipo,
    ...
    if (updated) {
      ...
      setSnackbar({ open: true, message: 'Error al actualizar el propietario', severity: 'error' });
    }
  };
